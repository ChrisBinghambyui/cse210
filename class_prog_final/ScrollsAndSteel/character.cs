...
{
    // The central class of the program. A Character is built from a Race plus
    // a set of Attributes and Skills, and calculates its own derived stats
    // (HP, MP, FP, and the other Chapter 2 formulas) from those values.
    public class Character
    {
        ...
        // Used for brand new characters: racial bonuses are applied once,
        // automatically, as part of character creation.
        public Character(string name, Race race, Dictionary<string, int> startingAttributes)
            : this(name, race, startingAttributes, true)
        {
        }

        // Used when loading a saved character: the saved Attribute values are
        // already final, so racial bonuses should NOT be applied again.
        ...
        // Private: outside code should never apply racial bonuses directly -
        // it happens automatically, once, when the Character is constructed.
        ...
        // Turns this Character into a single line of text so it can be saved
        // to a file. Follows the same idea as the Encode() methods used for
        // Goals in the Gamification project: each object knows how to turn
        // itself into text, and CharacterFileManager just writes that text out.
        ...
        // Chapter 2 derived stat formulas.
