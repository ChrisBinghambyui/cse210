...
namespace ScrollsAndSteel
{
    public class Program
    {
        ...
        // Builds one Race object based on the player's numbered choice.
        // Adding a new lineage means: add its name to RaceNames above,
        // then add one more case to RaceFactory.
        ...
        // Chapter 2: set all Attributes to 40, then distribute 30 extra points.
        ...
        // Chapter 3: choose 5 Major skills (start at 40) and 5 Minor skills
        // (start at 25). Everything else is Miscellaneous (starts at 5).
